...
def hitung_luas():
    ...
    t_segitiga = float(txtt_segitiga.get())

    L = (sisi_alas ** 2) + 2 * sisi_alas * (t_limas + t_segitiga)
...
# Tambahkan judul
app.title("Kalkulator Luas Permukaan dan Volume Limas Segi Empat")
...
txtt_segitiga = Entry(frame)
txtt_segitiga.grid(row=3, column=1)
