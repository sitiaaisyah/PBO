...
class FrmTranslator:
    ...
    def aturKomponen(self):
        ...
        # pasang Label
        Label(mainFrame, text='Masukkan teks:', bg="pink").grid(row=0, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Hasil Korea:', bg="pink").grid(row=2, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Hasil sunda:', bg="pink").grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Hasil Arabic:', bg="pink").grid(row=6, column=0,
            sticky=W, padx=5, pady=5)
        ...
        Label(mainFrame, text='Siti Aisyah 220511090', bg="pink").grid(row=8, column=1, pady=5, padx=5)

        # Pasang Button
        self.btnTranslate = Button(mainFrame, text='Translate!',
            command=self.onTranslate, bg="pink")
    ...
    def onTranslate(self):
        ...
        # menterjemahkan
        hasil = penterjemah.translate(self.txtSumber.get(), src='id', dest='ko') 
        hasil2 = penterjemah.translate(self.txtSumber.get(), src='id', dest='su') 
        hasil3 = penterjemah.translate(self.txtSumber.get(), src='id', dest='ar') 
